...
const DEFAULT_STORE: PlansStore = {
  plans: [
    createDefaultPlan({
      ...
      name: "Бесплатный",
      description: `
        • Режим "Один вопрос" — до 3 сессий в день\n• Режим "Практика" — 1 сессия в день\n• Режим "Экзамен" недоступен\n• Режим "Интервальный" недоступен\n• Ограниченный функционал статистики и работы над ошибками
      `,
      price: 0,
      currency: "RUB",
      limits: {
    ...
    createDefaultPlan({
      ...
      name: "Базовый",
      description: `
        • Режимы "Один вопрос" и "Практика" без ограничений\n• Режим "Экзамен" — 1 сессия в день\n• Режим "Интервальный" недоступен\n• Ограниченный функционал статистики и работы над ошибками
      `,
      price: 299,
      currency: "RUB",
      limits: {
    ...
    createDefaultPlan({
      ...
      name: "Pro",
      description: `
        • Режимы "Один вопрос" и "Практика" без ограничений\n• Режим "Экзамен" без ограничений\n• Режим "Интервальный" без ограничений\n• Полный функционал статистики и работы над ошибками
      `,
      price: 389,
      currency: "RUB",
      limits: {
